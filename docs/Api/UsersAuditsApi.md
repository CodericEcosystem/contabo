# Contabo\ContaboSdk\UsersAuditsApi
...
> \Contabo\ContaboSdk\Model\ListUserAuditResponse retrieveUserAuditsList($x_request_id, $x_trace_id, $page, $size, $order_by, $user_id, $request_id, $changed_by, $start_date, $end_date)
...
$apiInstance = new Contabo\ContaboSdk\Api\UsersAuditsApi(
...
[**\Contabo\ContaboSdk\Model\ListUserAuditResponse**](../Model/ListUserAuditResponse.md)

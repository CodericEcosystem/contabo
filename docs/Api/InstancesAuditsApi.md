# Contabo\ContaboSdk\InstancesAuditsApi
...
> \Contabo\ContaboSdk\Model\ListInstancesAuditResponse retrieveInstancesAuditsList($x_request_id, $x_trace_id, $page, $size, $order_by, $instance_id, $request_id, $changed_by, $start_date, $end_date)
...
$apiInstance = new Contabo\ContaboSdk\Api\InstancesAuditsApi(
...
$instance_id = 789; // int | The identifier of the instances.
...
[**\Contabo\ContaboSdk\Model\ListInstancesAuditResponse**](../Model/ListInstancesAuditResponse.md)

# Contabo\ContaboSdk\TagsAuditsApi
...
> \Contabo\ContaboSdk\Model\ListTagAuditsResponse retrieveTagAuditsList($x_request_id, $x_trace_id, $page, $size, $order_by, $tag_id, $request_id, $changed_by, $start_date, $end_date)
...
$apiInstance = new Contabo\ContaboSdk\Api\TagsAuditsApi(
...
[**\Contabo\ContaboSdk\Model\ListTagAuditsResponse**](../Model/ListTagAuditsResponse.md)

...
class SnapshotsApi
{
     ...
     *
     * @param  \Contabo\ContaboSdk\Model\CreateSnapshotRequest $body body (required)
     ...
     * @return \Contabo\ContaboSdk\Model\CreateSnapshotResponse
     */
    public function createSnapshot($body, $x_request_id, $instance_id, $x_trace_id = null)
    {
        list($response) = $this->createSnapshotWithHttpInfo($body, $x_request_id, $instance_id, $x_trace_id);
        return $response;
    }
     ...
     * Create a new instance snapshot
     *
     * @param  \Contabo\ContaboSdk\Model\CreateSnapshotRequest $body (required)
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  int $instance_id The identifier of the instance (required)
     * @param  string $x_trace_id Identifier to trace group of requests. (optional)
     *
     * @throws \Contabo\ContaboSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Contabo\ContaboSdk\Model\CreateSnapshotResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSnapshotWithHttpInfo($body, $x_request_id, $instance_id, $x_trace_id = null)
    {
        $returnType = '\Contabo\ContaboSdk\Model\CreateSnapshotResponse';
        $request = $this->createSnapshotRequest($body, $x_request_id, $instance_id, $x_trace_id);
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Contabo\ContaboSdk\Model\CreateSnapshotResponse',
     ...
     */
    public function createSnapshotAsync($body, $x_request_id, $instance_id, $x_trace_id = null)
    {
        return $this->createSnapshotAsyncWithHttpInfo($body, $x_request_id, $instance_id, $x_trace_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSnapshotAsyncWithHttpInfo($body, $x_request_id, $instance_id, $x_trace_id = null)
    {
        $returnType = '\Contabo\ContaboSdk\Model\CreateSnapshotResponse';
        $request = $this->createSnapshotRequest($body, $x_request_id, $instance_id, $x_trace_id);
     ...
     */
    protected function createSnapshotRequest($body, $x_request_id, $instance_id, $x_trace_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteSnapshotRequest($x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Contabo\ContaboSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Contabo\ContaboSdk\Model\FindSnapshotResponse
     */
     ...
     * @throws \Contabo\ContaboSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Contabo\ContaboSdk\Model\FindSnapshotResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveSnapshotWithHttpInfo($x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        $returnType = '\Contabo\ContaboSdk\Model\FindSnapshotResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Contabo\ContaboSdk\Model\FindSnapshotResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveSnapshotRequest($x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Contabo\ContaboSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Contabo\ContaboSdk\Model\ListSnapshotResponse
     */
     ...
     * @throws \Contabo\ContaboSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Contabo\ContaboSdk\Model\ListSnapshotResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Contabo\ContaboSdk\Model\ListSnapshotResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Contabo\ContaboSdk\Model\ListSnapshotResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveSnapshotListRequest($x_request_id, $instance_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  \Contabo\ContaboSdk\Model\RollbackSnapshotRequest $body body (required)
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  int $instance_id The identifier of the instance (required)
     * @param  string $snapshot_id The identifier of the snapshot (required)
     * @param  string $x_trace_id Identifier to trace group of requests. (optional)
     ...
     * @throws \Contabo\ContaboSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Contabo\ContaboSdk\Model\RollbackSnapshotResponse
     */
    public function rollbackSnapshot($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        list($response) = $this->rollbackSnapshotWithHttpInfo($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id);
        return $response;
    }
     ...
     * Revert the instance to a particular snapshot based on its identifier
     *
     * @param  \Contabo\ContaboSdk\Model\RollbackSnapshotRequest $body (required)
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  int $instance_id The identifier of the instance (required)
     * @param  string $snapshot_id The identifier of the snapshot (required)
     * @param  string $x_trace_id Identifier to trace group of requests. (optional)
     ...
     * @throws \Contabo\ContaboSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Contabo\ContaboSdk\Model\RollbackSnapshotResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function rollbackSnapshotWithHttpInfo($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        $returnType = '\Contabo\ContaboSdk\Model\RollbackSnapshotResponse';
        $request = $this->rollbackSnapshotRequest($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Contabo\ContaboSdk\Model\RollbackSnapshotResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rollbackSnapshotAsync($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        return $this->rollbackSnapshotAsyncWithHttpInfo($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rollbackSnapshotAsyncWithHttpInfo($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        $returnType = '\Contabo\ContaboSdk\Model\RollbackSnapshotResponse';
        $request = $this->rollbackSnapshotRequest($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function rollbackSnapshotRequest($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  \Contabo\ContaboSdk\Model\UpdateSnapshotRequest $body body (required)
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  int $instance_id The identifier of the instance (required)
     * @param  string $snapshot_id The identifier of the snapshot (required)
     * @param  string $x_trace_id Identifier to trace group of requests. (optional)
     ...
     * @throws \Contabo\ContaboSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Contabo\ContaboSdk\Model\UpdateSnapshotResponse
     */
    public function updateSnapshot($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        list($response) = $this->updateSnapshotWithHttpInfo($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id);
        return $response;
    }
     ...
     * Update specific snapshot by id
     *
     * @param  \Contabo\ContaboSdk\Model\UpdateSnapshotRequest $body (required)
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  int $instance_id The identifier of the instance (required)
     * @param  string $snapshot_id The identifier of the snapshot (required)
     * @param  string $x_trace_id Identifier to trace group of requests. (optional)
     ...
     * @throws \Contabo\ContaboSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Contabo\ContaboSdk\Model\UpdateSnapshotResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSnapshotWithHttpInfo($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        $returnType = '\Contabo\ContaboSdk\Model\UpdateSnapshotResponse';
        $request = $this->updateSnapshotRequest($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Contabo\ContaboSdk\Model\UpdateSnapshotResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSnapshotAsync($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        return $this->updateSnapshotAsyncWithHttpInfo($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSnapshotAsyncWithHttpInfo($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        $returnType = '\Contabo\ContaboSdk\Model\UpdateSnapshotResponse';
        $request = $this->updateSnapshotRequest($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateSnapshotRequest($body, $x_request_id, $instance_id, $snapshot_id, $x_trace_id = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateSnapshot'
            );
        }
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {

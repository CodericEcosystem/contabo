...
class UpdateUserRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets first_name
     *
     * @param string $first_name The name of the user. Names may contain letters, numbers, colons, dashes, and underscores. There is a limit of 255 characters per user.
     *
     * @return $this
     */
     ...
     * Sets roles
     *
     * @param int[] $roles The roles as list of `roleId`s of the user.
     *
     * @return $this
     */

 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpgradeObjectStorageRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpgradeObjectStorageRequest';
     ...
     * Gets auto_scaling
     *
     * @return AllOfUpgradeObjectStorageRequestAutoScaling
     */
     ...
     * Sets auto_scaling
     *
     * @param AllOfUpgradeObjectStorageRequestAutoScaling $auto_scaling New monthly object storage size limit for autoscaling if enabled.
     *
     * @return $this
     */
     ...
     *
     * @param double $total_purchased_space_tb New total object storage limit. If this number is larger than before you will also be billed for the added storage space. No downgrade possible.
     *
     * @return $this
     */

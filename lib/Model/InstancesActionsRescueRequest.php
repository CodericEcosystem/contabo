 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InstancesActionsRescueRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstancesActionsRescueRequest';
     ...
     * Sets root_password
     *
     * @param int $root_password `secretId` of the password to login into rescue system for the `root` user.
     *
     * @return $this
     */
     ...
     * Sets ssh_keys
     *
     * @param int[] $ssh_keys Array of `secretId`s of public SSH keys for logging into rescue system as `root` user.
     *
     * @return $this
     */

 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateObjectStorageRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateObjectStorageRequest';
     ...
     * Gets auto_scaling
     *
     * @return AllOfCreateObjectStorageRequestAutoScaling
     */
     ...
     * Sets auto_scaling
     *
     * @param AllOfCreateObjectStorageRequestAutoScaling $auto_scaling Autoscaling settings
     *
     * @return $this
     */
     ...
     * Sets display_name
     *
     * @param string $display_name Display name helps to differentiate between object storages, especially if they are in the same region. If display name is not provided, it will be generated. Display name can be changed any time.
     *
     * @return $this
     */

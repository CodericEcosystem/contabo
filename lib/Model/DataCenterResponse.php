 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataCenterResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataCenterResponse';
    ...
    const CAPABILITIES_VPS = 'VPS';
    const CAPABILITIES_VDS = 'VDS';
    const CAPABILITIES_OBJECT_STORAGE = 'Object-Storage';
    const CAPABILITIES_PRIVATE_NETWORKING = 'Private-Networking';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['region_slug'] = isset($data['region_slug']) ? $data['region_slug'] : null;
